...
void loop() {
  ...
  if (currentFrequency >= 392 && currentFrequency <= 396) {
    if (frequency >= 651 && frequency <= 663) {
      digitalWrite(8, HIGH);
      currentFrequency = frequency;
      Serial.println(currentFrequency);
    }
  }
  if (currentFrequency >= 651 && currentFrequency <= 663) {
    if (frequency >= 582 && frequency <= 600) {
      digitalWrite(9, HIGH);
      currentFrequency = frequency;
      Serial.println(currentFrequency);
    }
  }
  if (currentFrequency >= 582 && currentFrequency <= 600) {
    if (frequency >= 493 && frequency <= 506) {
      digitalWrite(10, HIGH);
      currentFrequency = frequency;
      Serial.println(currentFrequency);
    }
  }
  if (currentFrequency >= 493 && currentFrequency <= 506) {
